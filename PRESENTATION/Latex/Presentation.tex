...
\section{Stampa 3D}
  ...
  \begin{frame}
    ...
    \onslide*<1>{
      \begin{figure}[h]
        \centering
        \caption{Workflow di modellazione e slicing}
        \includegraphics[width=0.75\textwidth]{Pictures/Vector/PDF/3dprinting_diagram.pdf}
  ...
  \begin{frame}
    ...
    \onslide*<3-6>{
      \begin{center}
        Quali sono i \textbf{parametri di stampa} fondamentali?
      \end{center}
    }
  ...
  \begin{frame}
    \frametitle{Analisi Meccanica Dinamica}
      ...
      \onslide*<1>{L'\textbf{analisi meccanica dinamica} (DMA) è un'analisi termica utilizzata per lo studio delle proprietà viscoelastiche dei materiali. \\ 
      ...
      \begin{itemize}
        \item <3-6> Modulo di conservazione $E'$
        \item <4-6> Modulo di perdita $E''$
        \item <5-6> Fattore di smorzamento $tan \delta = \frac{E''}{E'}$
        \item <6>  \textbf{Temperatura di transizione vetrosa $T_g$}

      \end{itemize}

      \onslide*<3>{Il modulo di conservazione è indice del comportamento elastico del materiale.}
      \onslide*<4>{Il modulo di perdita è indice della dissipazione di energia sotto forma di calore.}
      \onslide*<5>{Il fattore di smorzamento è il rapporto tra i due moduli.}
      \onslide*<6>{La temperatura di transizione vetrosa è deducibile dal massimo della $tan \delta$, con maggiore precisione rispetto ad una DSC.}
  ...
  \begin{frame}
    ...
    \onslide*<1>{A conferma dell'ottima stabilità termica del PHBH, è stata effettuata un'altra \textbf{analisi termogravimetrica}}
...
\section{Conclusioni}
  ...
  \begin{frame}
    \frametitle{Innovazione}
      ...
      \onslide*<1-5>{
        \begin{center}
          Risultati ottenuti ben oltre le aspettative ed estremamente \textbf{innovativi}:
        \end{center}
      }
