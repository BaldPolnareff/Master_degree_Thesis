...
\begin{document}
    ...
    %\newacronym{PHBH}{PHBH}{Poly(3-hydroxybutirate-\textit{co}-3-hydroxyhexanoate)}
%
    %\makeglossary
    %\newpage
    \begin{abstract}
    ...
    at the \textit{Thermal Analysis} lab of the same department. \\ 
        ...
        equipment (\ref{recipe_improvement, faulty_equipment}), as well as tweaking of the precipitation 
