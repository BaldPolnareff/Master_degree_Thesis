...
\begin{document}
    ...
    petrochemical polymers, due to its early-stage synthesis process that could be further improved, its high cost and the strict confidentiality 
    of polymer manufacturers \autocite{Eraslan_PHBH_review}.  \clearpage

    \section{PBS (Polybutylene Succinate) \label{PBS_in_general}}

    PBS is an eco-friendly biopolymer with excellent properties and major benefits over comparable materials, which rose interest among 
    industrial and academic environments, as well as some minor drawbacks, which currently hold back its full potential. \\ 
    ...
    (at least with traditional methods), flexibility, as well as visual clarity and specularity. 
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=\textwidth]{Pictures/particle_size_stirring.eps}
    ...
    Cryogenic milling seems to be a more sustainable option for powder production, however, the issues discussed in \ref{Mechanical_milling}, 
    ...
    post processing with thermal rounding of the particles \autocite{DechetMaximilianA2020OtDo}. \\ 
    
    While powder production by 
    ...
    The entire purpose of utilizing biopolymers in the first place might be pointless if their powder production 
    utilizes compounds or processes that are not environmentally friendly. \\ 

    Better innovative solutions or mitigations of these issues in the current pipelines need to be implemented in the near future. \\ 
    ...
    While the former method has a better process yield and a reduced risk of lumping, the latter produces powders with 
