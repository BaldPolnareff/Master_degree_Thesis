        ...
        based on the available data. 
            ...
            \subsubsection{Results}
                ...
                \begin{table}[h!]
                       ...
                       $ID = PDSC_{(10 \ ^{\circ}C/min)}-01$ & 8.5000                   & 10                           & pellet               \\
                       $ID = pDSC_{(10 \ ^{\circ}C/min)}-02$ & 8.0000                   & 10                           & powder                \\
                       \bottomrule
                       \end{tabular}% 
                       }
                 \caption{DSC specimens}
...
%
    ...
    by shaking the container for a few minutes. \\
        ...
        %%%%%%%Metti qui la tabella con i dati dei pezzi stampati%%%%%% 
        ...
        \begin{figure}[h!]
            ...
            \begin{subfigure}[a]{0.55\textwidth}
                ...
                \subcaption{Specimen blablabla, used for DMA testing.}
        ...
        \begin{figure}[h!]
            ...
            \begin{subfigure}[a]{0.41\textwidth}
                ...
                \subcaption{Specimen blablabla, showcasing an organic pattern.}
                % Indica quale nella caption, in base alla tabella
            \end{subfigure}
                \vfill
            \begin{subfigure}[b]{0.5\textwidth}
                ...
                \subcaption{Specimen blablabla, showcasing an octagon with a circular array of octagon holes.}
                % Indica quale nella caption, in base alla tabella
            \end{subfigure}
