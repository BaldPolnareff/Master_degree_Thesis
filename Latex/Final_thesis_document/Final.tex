    ...
    The thermal analysis tools used in this case study are the Differential Scanning Calorimetry (DSC) and the Thermogravimetric Analysis (TGA).
        ...
        based on the available data. 
            ...
            \subsubsection{Results}
                ...
                It is equipped with a \textit{Gas Controller GC100}, in the temperature range from $-50 \ °C$ 
                to $250 \ °C$ with 
                a heating rate of $10 \ (or \ 5) \ °C/min$, and from $250°$ to $-50 \ °C$ with a cooling rate of $10 \ (or \ 5) \ °C/min$, 
                under nitrogen flow $(50 \ mL/min)$. \\ 

                The included \textit{Mettler-Toledo STARe software} (V9.2) allows for the analysis of the 
