...
%
    ...
    by shaking the container for a few minutes. \\
        ...
        where 0.3 is the fixed layer height (which is machine dependant), N is the number of layers
        and everything is divided by a factor of two, given that there are two 
        side tanks next to the central printing area. 
