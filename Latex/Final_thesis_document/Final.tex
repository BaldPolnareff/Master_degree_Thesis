...
\begin{document}
    ...
    \begin{abstract}
        The goal of this case study is to optimize the production of SLS suitable fine powders of sustainable biopolymers and directly assess their printability. 
        ...
        The resulting powder has been characterized by means of a series of tests, including various \textit{thermal analysis} methods and \textit{dynamic mechanical analysis}.

        The powder has been successfully printed on a \textit{Sharebot Snowhite²} SLS 3D printer, achieving a print quality comparable to that of standard SLS polymers such as PA12.
